...
#project name = Voice Recording through python
#Requires one operator

#make sure you have all the required libraries installed (tkinter, PIL, imageio, pyaudio, sounddevice, numpy, and wavio).
